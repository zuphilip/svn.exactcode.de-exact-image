...
void colorspace_gray8_to_gray2 (Image& imagey);
void colorspace_gray8_to_gray4 (Image& imagey);
void colorspace_gray8_to_rgb8 (Image& image);


void colorspace_gray1_to_gray2 (Image& imagey);
void colorspace_gray1_to_gray4 (Image& imagey);
